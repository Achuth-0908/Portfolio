  ...
  return (
    <div className="max-w-4xl mx-auto">
      {education.map((edu, index) => (
        <motion.div
          key={index}
          className="mb-8 p-6 bg-slate-900/60 border border-slate-700/50 rounded-2xl shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 relative overflow-hidden group"
          ...
          <div className="mt-4 relative z-10">
            ...
            <div className="space-y-2">
              {edu.points.map((point, pIdx) => (
                <div key={pIdx} className="flex items-start gap-3 text-slate-300">
