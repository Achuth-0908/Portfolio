...
export default function App() {
  ...
  return (
    <div className="relative bg-slate-950">
      {/* ✅ Bubble background across full page */}
      ...
      {/* ✅ Page Sections */}
      <main className="relative text-white z-10">
        <motion.section
          id="home"
      ...
      <footer className="bg-slate-950/80 backdrop-blur-md border-t border-slate-800 p-6 text-center z-10">
        <p className="text-slate-400">
          &copy; {new Date().getFullYear()} G ACHUTH.
        </p>
      </footer>
    </div>
  )
